import 'dart:async';
import 'package:trial/schemes/garibkalyan.dart';
import 'package:trial/schemes/ujwal.dart';
import 'package:flutter/material.dart';
import 'package:trial/schemes/nidhi.dart';
import 'main.dart';


class MyAppgov extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyPage> {
  ...
  Future<Widget> getImage() async {
    ...
    final image = AssetImage('assets/gramujwal.jpeg');
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      const ListTile(
                        ...
                        title: Text('Gram Ujala Yojana'),
                        subtitle: Text('A customized program of Ministry of Power for rural India to make LEDs available at affordable cost'),
                      ),
                      Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    const ListTile(
                      ...
                      subtitle: Text('The Government of India launched the Garib Kalyan Rojgar Abhiyaan initiative to tackle the impact of COVID-19 on shramik workers in India.'),
                    ),
                    Container(
                      alignment: Alignment.center,
                      child: new Image.asset('assets/Blog-Garib-Kalyan-Rojgar-Abhiyaan.jpg'),
                    )
                    ,
                    ButtonTheme( // make buttons use the appropriate styles for cards
                      child: ButtonBar(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    const ListTile(
                      ...
                      subtitle: Text('The PM-KISAN is a central sector scheme launched to supplement financial needs of land holding farmers.'),
                    ),
                    Container(
                      alignment: Alignment.center,
                      child: new Image.asset('assets/kissansamaan.jpeg'),
                    )
                    ,
                    ButtonTheme( // make buttons use the appropriate styles for cards
                      child: ButtonBar(
