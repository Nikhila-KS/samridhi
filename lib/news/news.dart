import 'dart:async';
import 'package:trial/news/news1.dart';
import 'package:trial/news/news2.dart';
import 'package:trial/news/news3.dart';
import 'package:flutter/material.dart';



class MyAppnn extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyPage(title: 'Goverment Schemes'),
    );
  }
}
              ...
              Card(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      alignment: Alignment.center,
                      child: new Image.asset('assets/wheat.jpeg'),
                    )
                    ,
                    ButtonTheme( // make buttons use the appropriate styles for cards
                      child: ButtonBar(
                        children: <Widget>[
                          TextButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder:(context)=> MovieDetailScreen233(),),);},
                          ),
                        ],
                      ),
                    ),
              ...
              Card(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      alignment: Alignment.center,
                      child: new Image.asset('assets/agriagri.jpeg'),
                    )
                    ,
                    ButtonTheme( // make buttons use the appropriate styles for cards
                      child: ButtonBar(
                        children: <Widget>[
                          TextButton(
                            ...
                            onPressed: () {
                              Navigator.push(context,
                                MaterialPageRoute(builder:(context)=> MovieDetailScreen3654(),),);},
                          ),
                        ],
                      ),
                    ),
...
//         visualDensity: VisualDensity.adaptivePlatformDensity,
//       ),
//       home: MyPage(title: 'GOVERNMENT NEWS'),
//     );
//   }
// }
//
...
//   Future<Widget> getImage() async {
//     final Completer<Widget> completer = Completer();
//     final image = AssetImage('assets/wheat-nirmal-harindran.jpg');
//     // final config = await image.obtainKey();
//     final load = image.resolve(const ImageConfiguration());
//
//     final listener = new ImageStreamListener((ImageInfo info, isSync) async {
...
//                     Container(
//                       alignment: Alignment.center,
//                       child: new Image.asset('assets/WhatsApp Image 2022-09-01 at 9.48.18 PM.jpeg'),
//                     )
//                     ,
//                     ButtonTheme( // make buttons use the appropriate styles for cards
//                       child: ButtonBar(
...
//                             onPressed: () {
//                               Navigator.push(context,
//                                 MaterialPageRoute(builder:(context)=> MovieDetailScreen2(),),);},
//                           ),
//                         ],
//                       ),
//                     ),
...
//                     const ListTile(
//                       leading: Icon(Icons.album),
//                       title: Text('Govt launches 11th agricultural census 2021-22; to use smartphones, tablets for data collection',
//                         style: TextStyle(
//                             fontWeight: FontWeight.bold
//                         ),),
//                       subtitle: Text('..'),
...
//                     Container(
//                       alignment: Alignment.center,
//                       child: new Image.asset('assets/WhatsApp Image 2022-09-01 at 9.55.46 PM.jpeg'),
//                     )
//                     ,
//                     ButtonTheme( // make buttons use the appropriate styles for cards
//                       child: ButtonBar(
...
//                             onPressed: () {
//                               Navigator.push(context,
//                                 MaterialPageRoute(builder:(context)=> MovieDetailScreen3(),),);},
//                           ),
//                         ],
//                       ),
//                     ),
